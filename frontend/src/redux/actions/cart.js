  ...
  if (localStorage.getItem("access")) {
    ...
    try {
      const res = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/cart/add-item`,
        body,
        config
      );
  ...
  if (localStorage.getItem("access")) {
    ...
    try {
      const res = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/cart/cart-items`,
        config
      );
...
export const get_total = () => async (dispatch) => {
  if (localStorage.getItem("access")) {
    ...
    try {
      const res = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/cart/get-total`,
        config
      );
...
export const get_item_total = () => async (dispatch) => {
  if (localStorage.getItem("access")) {
    ...
    try {
      const res = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/cart/get-item-total`,
        config
      );
  ...
  if (localStorage.getItem("access")) {
    ...
    try {
      const res = await axios.put(
        `${import.meta.env.VITE_API_URL}/api/cart/update-item`,
        body,
        config
      );
...
export const empty_cart = () => async (dispatch) => {
  if (localStorage.getItem("access")) {
    ...
    try {
      const res = await axios.delete(
        `${import.meta.env.VITE_API_URL}/api/cart/empty-cart`,
        config
      );
